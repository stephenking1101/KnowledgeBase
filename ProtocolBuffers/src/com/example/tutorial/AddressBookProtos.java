...
public final class AddressBookProtos {
  ...
  checkByteStringIsUtf8(value);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!getTestBytes().isEmpty()) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 6, test_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!getTestBytes().isEmpty()) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(6, test_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
  ...
  static {
    ...
    internal_static_tutorial_Person_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_tutorial_Person_descriptor,
        new java.lang.String[] { "Name", "Id", "Email", "Phones", "LastUpdated", "Test", });
    internal_static_tutorial_Person_PhoneNumber_descriptor =
